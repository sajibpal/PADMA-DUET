...
public class ImageGallery extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        viewGallery.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(ImageGallery.this, ViewImageActivity.class);
        ...
        btnUploadImage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (mUploadTask != null && mUploadTask.isInProgress()) {
                    Toast.makeText(ImageGallery.this, "Upload in progress", Toast.LENGTH_LONG).show();
                }

               else if ( imgDescription.getText().toString().trim().equalsIgnoreCase("")) {
                         imgDescription.setError("This field can not be blank");
                     }
    ...
    public  boolean onOptionsItemSelected(MenuItem item){
        ...
        if(item.getItemId()==R.id.logout){
              ...
              Intent intent = new Intent(ImageGallery.this,Home.class);
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (requestCode == CHOOSE_IMAGE && resultCode == RESULT_OK && data != null && data.getData() != null) {
            ...
            Toast.makeText(this, "Please Select Image Max Size 2MB", Toast.LENGTH_LONG).show();
        }
    ...
    private void uploadImage() {
        if (imgUrl != null) {
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            ...
                            fileReference.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                                ...
                                public void onSuccess(Uri uri) {
                                    ...
                                    Toast.makeText(ImageGallery.this, "Upload successfully", Toast.LENGTH_LONG).show();
            ...
            Toast.makeText(ImageGallery.this, "No file selected", Toast.LENGTH_SHORT).show();
        }
    }
